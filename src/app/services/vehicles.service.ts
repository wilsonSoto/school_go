...
export class VehiclesService {
  ...
  getBus(partner_id: number) {

console.log(';;;;;;;;;;;;;;;;;;;;;;;;;;;;')

    const url =  `${this.appURl}/school/buses/${partner_id}/info`;
...
console.log(';;;;;;;;;;;;;;;;;;;;;;;;;;;;')
    ...
    const url =  this.appURl +'/school/buses/';
    return this.httpClient.get(url).pipe(
      map((res: any) => {
        return res;
      })
  ...
  async postBuses (data: any) {
   ...
   if (company_id || action == 'edit') {
     url = `${this.appURl}/school/${data.company_id}/buses/signup`;
    } else {
      url = `${this.appURl}/school/buses/${partner_id}/student/`;
    }

    // const url =  `${this.appURl} /school/${company_id}/buses/signup`;
